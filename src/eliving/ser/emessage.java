 ...
 */
@WebServlet("/emessage")
public class emessage extends HttpServlet {
	...
	try{
			...
			String strins="insert into sentitem(senderid,receiverid,subject,message,dateofmsg,documents) values(?,?,?,?,?,?)";
			String strins1="insert into inbox(senderid,receiverid,subject,message,dateofmsg,documents) values(?,?,?,?,?,?)";
			...
			psnews1.setString(1,recid1);
			psnews1.setString(2,sendid1);
			...
			response.sendRedirect("/eliving/html/msgsent.html");
		}}
